...
public abstract interface GenericDao<T, PK extends Serializable> {  
     ...
     */  
    public abstract PageResult<T> selectPagination(Object param);  
     ...
     * @return PaginationResult对象，包括（符合条件的）总记录数、页实体对象List等 
     */  
    public abstract PageResult<T> selectFkPagination(Object param);  
      
    /** 
     * 批量插入 
     * @description 批量插入有数据限制，在做数据迁移时要尤其注意大概是70~80W行记录,如果超出就会outOfMemory
     * @param list 
     */  
