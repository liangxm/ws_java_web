!function(t, n, r, e) {
	...
	!function() {
		var t = 1, n = {};
		r.getStopRecursionFn = function(e, i) {
			if (r.isFunction(e)) {
				var o = function() {
					if (!n[e.__stopRecursion]) {
						n[e.__stopRecursion] = true;
						e.apply(i || window, arguments);
						delete n[e.__stopRecursion]
					} else
						return i || window
				};
				if (e.__stopRecursion)
					return o;
				else {
					e.__stopRecursion = t;
					t += 1;
	...
	var i = t.Game = t.Game || {}, o = function(t) {
		var n = i.getCdnUrl(), r = i.getVersionId(), e = i, o = "";
		n += "/js2/game";
		if ("string" === typeof t) {
			t = t.split(".");
		...
		var n = i._toStrings, r = Object.prototype.toString, o = {
			1 : "element",
			3 : "textnode",
			9 : "document",
			11 : "fragment"
		...
		if (!n) {
			n = {};
			var u = "Arguments Array Boolean Date Document Element Error Fragment Function NodeList Null Number Object RegExp String TextNode Undefined Window"
					.split(" ");
			for (var a = u.length; a--;) {
				var s = u[a], f = window[s];
				if (f)
					try {
		...
		return null == t
				...
				&& (t.callee && _arguments || t.alert && "window" || t.item
						&& "nodelist") || n[r.call(t)]
	}, s = function() {
	};
	s.fn = s.prototype = {
		...
		regEvent : function(t) {
			var n = a(t), i = this, o = i.getEventCache();
			switch (n) {
			case "string":
				t = t.split(" ");
			case "array":
		...
		callEvent : function(t, n, r) {
			var i, o, u, a, s, f, c, l = this, s = Array.prototype.slice.call(
					arguments, 1);
			if (!isNaN(t)) {
				i = parseInt(t) || 200, o = this.getEventCache()[n],
						u = o.length;
				if (0 === u)
					return;
				o.paras = s;
	...
	!function(t) {
		...
		u.prototype = {
			...
			run : function() {
				...
				if (this.running)
					return;
				if (!this.lastRunTime || t - this.lastRunTime >= this.interval
						&& this.interval
						&& (this.runNum < this.maxNum || !this.maxNum)) {
					this.running = 1;
					this.lastRunTime = t;
					this.runNum++;
					try {
						this.work(r.proxy(this.notice, this), this.runNum,
								this.maxNum)
					} catch (e) {
						n.log
								&& n.log("定时任务(" + this.guid
										+ ")运行错误！任务已经强制终止！", e);
						this.stop()
					}
				}
			...
			.extend(
					i,
					{
						...
						randomWeight : function(t, n) {
							var e = [], o, u, a, s, f, c = 0, l, h = {}, g = [], p, d, m, v = /^\d+$/;
							n = +n;
							if (t && r.isArray(t) && n) {
								s = 0;
								for (o = 0, a = t.length; o < a; o++)
									if (r.isArray(t[o]) && 2 == t[o].length) {
										if (t[o][0] && r.isArray(t[o][0])
												&& t[o][0].length) {
											l = +t[o][1];
											if (!l || l < 0)
												l = 0;
								...
								if (n < s) {
									...
									for (m in p)
										e = e.concat(i.random(h[m], p[m]))
								} else if (n == s)
									for (o = 0, a = t.length; o < a; o++)
										e = e.concat(t[o][0]);
								if (e.length && v.test(e.join("")))
									e.sort(function(t, n) {
										return +t - +n
									})
							}
						...
						fillZero : function(t, n) {
							var r = Math.floor(+t), e = r + "", i = [], o = n || 2, u = o
									- e.length, a = 0;
							for (; a < u; a++)
								i[a] = "0";
						...
						unique : function(t) {
							var n = [], e = Array.prototype.slice.call(
									arguments, r.isArray(t) ? 0 : 1), i = e.length, o = 0, u;
							if (0 == i)
								return;
							for (; o < i; o++) {
								u = e[o];
							...
							var o = e || function() {
								...
								if (6 == t.stopType) {
									r
											.dialog({
												type : "shell",
												content : '<div id="festivalDialog"><p>您可以购买：<a href="http://caipiao.163.com/order/ssq/#from=ts" style="margin-left: 7px;">双色球</a><a href="http://caipiao.163.com/order/dlt/#from=ts">大乐透</a><a href="http://caipiao.163.com/#from=ts">返回首页</a></p><a class="maShangFaLink" href="http://caipiao.163.com/activity/horseYearActivity.html#from=ts"></a></div>',
												width : 641,
												height : 371
											});
									o(999);
								...
								i.gameStop = true;
								i.loadMolude("notice.pause", function() {
									i.notice.pause(t, o)
								})
							};
							if ("object" === i.getType(t))
								u(t);
							else {
								jQuery(function() {
									n.popularizeConfigForBetPage(t)
								});
								n.get("/order/queryStopSaleInfo.html", {
									gameEn : t
								}, function(t, n) {
									if (t) {
										o(-1);
						...
						regBaseCom2Lib : function(t, n, e) {
							...
							r.extend(i.fn, e);
							var o = t.split("."), u = o.length, a = 0, f = this;
							for (; a < u; a++)
								if (a < u - 1)
									f = f[o[a]] = f[o[a]] || {};
								else
						...
						createCom : function(t, n, e) {
							var o = function(t) {
								var n = i || {}, r = t.split("."), e = r.length, o = 0;
								for (; o < e; o++) {
									n = n[r[o]];
									if (!n)
										break
							...
							var u = o(t), a = u ? new u(n) : null;
							if (a) {
								r.isFunction(e) && e(a);
								return a
							}
							this.loadMolude(t, function() {
								var i = o(t), u = i ? new i(n) : null;
								r.isFunction(e) && e(u)
							})
						},
						dialog : function(t, n) {
											...
											r
													.extend(
															...
															t,
															{
																...
																button : t.button
																		|| [ "*确定" ],
																content : "<div class='betDialogContent'><em></em><div class='betDialogContent2'>"
																		+ t.content
																		+ "</div></div>",
																width : t.width == e ? 430
																		: t.width,
						...
						getMoneyText : function(t) {
							...
							return t < n ? t : t < r ? "<span title='" + t
									+ "元！\n土豪，我们做朋友吧！'>" + (t / n).Round(2)
									+ "亿</span>" : "<span title='" + t
									+ "元！\n震精！请问您是哪路高人？'>" + (t / r).Round(2)
									+ "万亿</span>"
						},
